...
Входные данные
В первой строке входного файла INPUT.TXT содержится число n (1 ≤ n ≤ 10). В следующих n^2 строчках содержится по n^2 чисел, задающих нарисованный Васей Судоку.
