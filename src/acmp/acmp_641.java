...
Ниже приведен пример с N равным 995051.</p> <img src="/asp/article/image.asp?id=337" alt="Странная лотерея"> <p class="text">Максимальное число, которое может быть получено из данного N посредством вычеркивания двух цифр является 9955. Помогите Пете и Вове в этой непростой, но очень актуальной для них задачей.

Входные данные
В единственной строке входного файла INPUT.TXT находится число N (100 ≤ N &lt; 10^250). Число не содержит лидирующих нулей. Строка входного файла заканчивается переводом строки и не содержит символов отличных от "0"-"9".
